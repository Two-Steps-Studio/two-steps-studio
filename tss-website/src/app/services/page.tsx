...
export default function ServicesPage() {
  ...
  if (loading) {
    return (
      <div className="container mx-auto p-6 mt-20 max-w-6xl flex items-center justify-center min-h-[60vh]">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[var(--color-general)]" />
      </div>
    );
  }
