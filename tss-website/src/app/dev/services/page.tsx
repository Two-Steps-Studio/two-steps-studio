    ...
    <div className="container mx-auto p-6 mt-20 max-w-6xl pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {services.map((service) => (
          <Card
            key={service.id}
            className="glass rounded-[2rem] border border-[var(--border-color)] shadow-xl transition-all duration-300 hover:border-[var(--color-dev)]/50 hover:shadow-[var(--color-dev)]/10 group"
          >
            <CardHeader className="p-6 pb-4">
              <div className="flex items-center justify-between mb-2">
                <div className="p-2 rounded-xl bg-[var(--surface)] border border-[var(--border-color)] group-hover:border-[var(--color-dev)]/30 transition-colors">
