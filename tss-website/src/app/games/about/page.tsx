        ...
        <>
            ...
            <div className="space-y-8">
                ...
                <Card className="border-[var(--color-games)]/20 bg-[var(--color-games)]/5">
                    <CardHeader>
                        <CardTitle className="text-3xl md:text-4xl font-bold text-[var(--text)] font-[family-name:var(--font-space)]">
                ...
                {/* Od prototypu do gry */}
                <div>
                    <h2 className="text-3xl md:text-4xl font-bold text-[var(--text)] font-[family-name:var(--font-space)] mb-6">
                        {t.gamesAbout.prototypeTitle}
                    </h2>
                    <p className="text-[var(--text-muted)] max-w-3xl font-[family-name:var(--font-outfit)] text-lg leading-relaxed">
                        {t.gamesAbout.prototypeP1}
                    </p>
                    <p className="text-[var(--text-muted)] max-w-3xl font-[family-name:var(--font-outfit)] text-lg leading-relaxed mt-4">
                ...
                <div>
                    ...
                    <div className="space-y-6">
                        <div className="rounded-3xl border border-[var(--color-games)]/20 bg-[var(--color-games)]/5 p-6">
                            <h3 className="text-xl font-bold text-[var(--text)] font-[family-name:var(--font-space)] mb-3">{t.gamesAbout.gameplayFirstTitle}</h3>
                            <p className="text-[var(--text-muted)] font-[family-name:var(--font-outfit)] leading-relaxed">
                                {t.gamesAbout.gameplayFirstDesc}
                            </p>
                        </div>
                        <div className="rounded-3xl border border-[var(--color-games)]/20 bg-[var(--color-games)]/5 p-6">
                            <h3 className="text-xl font-bold text-[var(--text)] font-[family-name:var(--font-space)] mb-3">{t.gamesAbout.experimentingTitle}</h3>
                            <p className="text-[var(--text-muted)] font-[family-name:var(--font-outfit)] leading-relaxed">
                                {t.gamesAbout.experimentingDesc}
                            </p>
                        </div>
                        <div className="rounded-3xl border border-[var(--color-games)]/20 bg-[var(--color-games)]/5 p-6">
                            <h3 className="text-xl font-bold text-[var(--text)] font-[family-name:var(--font-space)] mb-3">{t.gamesAbout.growthTitle}</h3>
                            <p className="text-[var(--text-muted)] font-[family-name:var(--font-outfit)] leading-relaxed">
