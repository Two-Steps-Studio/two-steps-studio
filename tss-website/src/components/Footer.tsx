        ...
        <footer className="py-6 px-4 border-t border-[var(--border-color)] mt-6 w-full">
            <div className="w-full mx-auto flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4">
                ...
                <div className="order-2 sm:order-1">
                    <a
                    href="/terms"
                    className="text-[var(--text-muted)] text-sm font-medium tracking-wide hover:text-general transition-colors duration-200"
                    >
                    Terms of Use
                </a>
            </div>

            <div className="hidden sm:block w-px h-3.5 bg-[var(--surface-hover)] order-2" />
            ...
            <div className="hidden sm:block w-px h-3.5 bg-[var(--surface-hover)] order-4" />
